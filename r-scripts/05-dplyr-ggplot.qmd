...
# restore you library (always keep at the start of script - libraries will be synchronized between collaborators)
renv::restore()
...
ggplot(data=FactCockleSize, # what data
       mapping =aes(x=length_mm, y=thickness_mm)) + # what is on the axis        
  geom_point()                                      # insert data points

#there is a big outlier which is biological impossible, remove it

FactCockleSize |> dplyr::filter(thickness_mm>500)

# we want to make a niw dataset without this outlier
