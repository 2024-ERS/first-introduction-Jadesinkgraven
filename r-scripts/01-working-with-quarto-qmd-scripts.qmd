...
title: "Working with quarto documents that include R code" author: "Han Olff" date: "2024-08-29" format: html editor: markdown: wrap: 72 ---
...
```{r}
# define variable A and assign the value 5 to it
A <-5
# same for variable B
B <-10
...
# print the result
print(C)
# calculate mean of 5,24,33,45
my_numbers <-c(5,24,33,45)
